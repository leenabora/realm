    ...
    <div class="full-container">
        <div class="slider-content">
            ...
            <div class="slider slider-v2">
                <div class="slider-item slider-item-img1 " data-cycle-pager-template="<a href=#> UNLIMITED FASHION </a>">
                    <div class="sliderInfo">
                        <div class="container">
                            <div class="col-lg-4 col-md-3 col-sm-3 pull-right sliderText dark alpha80 hidden-xs">
                                <div class="inner">
                                    <h2>UNLIMITED FASHION</h2>
                ...
                <div class="slider-item slider-item-img3  parallax" data-cycle-pager-template="<a href=#> AGILE FASHION </a>">
                    ...
                    <img alt="img" src="<%=request.getContextPath()%>/images/slider/banner3_new.jpg" class="img-responsive parallaximg sliderImg"> </div>
                <!--/.slider-item-->
            </div>
            <!--/.slider-v2-->
        </div>
