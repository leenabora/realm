...
<footer>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <div class="pull-right paymentMethodImg"> <img height="30" class="pull-right" src="<%=request.getContextPath()%>/images/site/payment/master_card.png" alt="img" > <img height="30" class="pull-right" src="<%=request.getContextPath()%>/images/site/payment/paypal.png" alt="img" > <img height="30" class="pull-right" src="<%=request.getContextPath()%>/images/site/payment/american_express_card.png" alt="img" > <img  height="30" class="pull-right" src="<%=request.getContextPath()%>/images/site/payment/discover_network_card.png" alt="img" > <img  height="30" class="pull-right" src="<%=request.getContextPath()%>/images/site/payment/google_wallet.png" alt="img" > </div>
        </div>
    </div>
    <!--/.footer-bottom-->
</footer>
