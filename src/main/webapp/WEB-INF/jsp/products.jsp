        ...
        <ul class="dropdown-menu">
            <li class="megamenu-content ">
                ...
                <ul class="col-lg-3  col-sm-3 col-md-3  col-xs-4">
                    <li>
                        <a class="newProductMenuBlock" href="product-details.html">
                            <img class="img-responsive" src="<%=request.getContextPath()%>/images/site/promo1.jpg" alt="product">
                ...
                <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                    <li>
                        <a class="newProductMenuBlock" href="product-details.html">
                            <img class="img-responsive" src="<%=request.getContextPath()%>/images/site/promo2.jpg" alt="product">
                ...
                <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                    <li>
                        <a class="newProductMenuBlock" href="product-details.html">
                            <img class="img-responsive" src="<%=request.getContextPath()%>/images/site/promo3.jpg" alt="product">
            ...
            <li class="megamenu-content">
                ...
                <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                    <li class="no-margin productPopItem ">
                        ...
                        <a href="product-details.html">
                            <img class="img-responsive" src="<%=request.getContextPath()%>/images/site/g4.jpg" alt="img">
                        </a>
                ...
                <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                    <li class="no-margin productPopItem relative">
                        <a href="product-details.html">
                            <img class="img-responsive" src="<%=request.getContextPath()%>/images/site/g5.jpg" alt="img">
                        </a>
                        <a class="text-center productInfo alpha90" href="product-details.html"> Eodem modo typi <br>
                            <span> $60 </span> </a> </li>
                </ul>
